...
> ### type
> You can check if a command is a built-in command by using ```type``` <br>
> ![](../../Image/Exported%20image%2020250304130117-0.png) <br>
> <br>
> Some internal command are duplicated the external commands that do the same thing<br>
> You can check if internal commands have a duplicated external command by using ```–a``` <br>
> ![](../../Image/Exported%20image%2020250304130119-1.png) <br>
